      ...
      >
        <div className="flex justify-between items-center ease-in duration-500">
          <div className="flex justify-center items-center">
            ...
            <h2 className=" font-bold text-3xl mb-2 ml-2">Education</h2>
          </div>
        ...
        <div>
          ...
          {addButton === true ? (
            <Information
              ...
              objectPassed={educationFormObject}
              typeOfForm={"Education"}
              startDate={startDate}
              endDate={endDate}
